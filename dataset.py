...
class IMDBBertDataset(Dataset):
      ...
      def __getitem__(self, idx):
            ...
            token_mask = torch.Tensor(item[self.TOKEN_MASK_COLUMN]).long()
      ...
      def _select_false_nsp_sentences(self, sentences: typing.List[str]):
            ...
            sentence_index = random.randint(0, sentence_len - 1)
            next_sentence_index = random.randint(0, sentence_len - 1)
      ...
      def _mask_sentence(self, sentence: typing.List[str]):
            """
            Replace MASK_PERCENTAGE (15 %) of word with special [MASK] token
...
if __name__ == "__main__":
      ...
      ds = IMDBBertDataset(BASE_DIR.joinpath("data/imdb.csv"),
                           ds_from=0, 
                           ds_to=50000, 
